  ...
  html: function (title, list, body, control, authStatusUI = `<a href="/login">login</a> | <a href="/login/register">register</a>`) {
    return `
      ...
      <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://ec2-52-79-47-45.ap-northeast-2.compute.amazonaws.com/styles/style.css"></link>
        <script src="http://ec2-52-79-47-45.ap-northeast-2.compute.amazonaws.com/js/hello.js""></script>
      </head>
      <body>
        ${authStatusUI}
        ${list}
